...
# Download price for trading/re-balance
data_processor.download_asset_price(low_vol_stocks_names, CONSTANT.TRADING_DIR)
low_vol_stocks_price = data_processor.load_asset_price(CONSTANT.TRADING_DIR)
...
# Download price for trading/re-balance
data_processor.download_asset_price(high_vol_stocks_names, 'Trading_high_vol')
high_vol_stocks_price = data_processor.load_asset_price('Trading_high_vol')
